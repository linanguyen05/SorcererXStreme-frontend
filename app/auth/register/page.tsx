...
import { Eye, EyeOff, Mail, Lock, Sparkles, Star, Moon, ArrowLeft, Check, X, CheckCircle, XCircle } from 'lucide-react';
                  ...
                  <div className="relative bg-gray-900/90 hover:bg-gray-900/80 rounded-xl py-4 px-6 transition-all duration-300 flex items-center justify-center gap-2">
                    {isLoading ? (
                      ...
                      <>
                        ...
                        {isFormValid && <Sparkles size={16} className="text-yellow-200" />}
                      </>
                    )}
                  </div>
                </button>
