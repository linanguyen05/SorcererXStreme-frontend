...
import {
    Star, MapPin, Users, Award,
    Facebook, Youtube, Instagram, ExternalLink, Clock, Zap
} from 'lucide-react';
import { Expert, ExpertSpecialty, SocialLinks, formatPrice } from '@/lib/services-data';

// ─── Specialty config ───────────────────────────────────────────────────────
export const ALL_SPECIALTIES: ExpertSpecialty[] = [
...
// ─── Card Flip Tile ──────────────────────────────────────────────────────────
export function ExpertTile({ expert, index }: { expert: Expert; index: number }) {
